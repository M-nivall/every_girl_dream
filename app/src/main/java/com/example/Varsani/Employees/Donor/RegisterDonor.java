...
public class RegisterDonor extends AppCompatActivity {
    ...
    private EditText edt_firstname,edt_lastname,edt_username,edt_phoneNo,
    ...
    public void signUp(){
        ...
        StringRequest stringRequest=new StringRequest(Request.Method.POST, Urls.URL_REGISTER_DONOR,
