...
import static com.example.Varsani.utils.Urls.URL_COUNSELLING_REQUESTS;
...
public class AssignedCounselling extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_assigned_counselling);
    ...
    public void counsellingRequests(){
        StringRequest stringRequest=new StringRequest(Request.Method.POST, URL_MY_COUNSELLING_REQUESTS,
