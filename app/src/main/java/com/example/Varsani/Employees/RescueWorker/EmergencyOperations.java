package com.example.Varsani.Employees.RescueWorker;

import static com.example.Varsani.utils.Urls.URL_EMERGENCY_DUTIES;
import static com.example.Varsani.utils.Urls.URL_EMERGENCY_OPERATIONS;
...
public class EmergencyOperations extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_emergency_operations);
    ...
    public void newDuties(){
        StringRequest stringRequest=new StringRequest(Request.Method.POST, URL_EMERGENCY_OPERATIONS,
