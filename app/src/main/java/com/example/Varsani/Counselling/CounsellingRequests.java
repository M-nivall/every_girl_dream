...
public class CounsellingRequests extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_counselling_requests);
    ...
    public void counsellingRequests(){
        StringRequest stringRequest=new StringRequest(Request.Method.POST, URL_COUNSELLING_REQUESTS,
