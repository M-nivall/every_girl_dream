...
import static com.example.Varsani.utils.Urls.URL_NOTICES;
...
public class Notice extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setSubtitle("Notice");
    ...
    public void notice(){
        StringRequest stringRequest=new StringRequest(Request.Method.POST, URL_NOTICES,
