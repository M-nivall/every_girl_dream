...
public class Urls {
    ...
    //public static String ipAddress = "http://192.168.34.250/everygirldream/";

    public static String ipAddress = "https://8ddb-217-199-148-239.ngrok-free.app/everygirldream/";
    ...
    public static final String URL_GET_RESCUE_CENTERS=ROOT_URL + "emergency/rescue_centers.php";
    public static final String URL_COMPLETED_REPORTS=ROOT_URL + "emergency/completed_reports.php";
    ...
    public static final String URL_GET_TEAM_MEMBERS=ROOT_URL + "rescue_lead/get_team_members.php";

    //Rescue Worker
    public static final String URL_EMERGENCY_OPERATIONS=ROOT_URL + "rescue_worker/emergency_operations.php";
